...
> = {
  xero: {
    name: "Xero",
    subtitle: "Accounting, contacts, invoices and banking",
    accent: "bg-sky-500/10",
  },

  zoho: {
    name: "Zoho Books",
    subtitle: "Accounts, customers, invoices and bills",
    accent: "bg-orange-500/10",
  },

  tally: {
    name: "TallyPrime",
    subtitle: "Secure bridge from on-premise Tally data",
...
export default function IntegrationsPage() {
  ...
  const createTallyBridge = async () => {
    try {
      ...
      const response =
        await integrationService.createTallyToken();
  ...
  const chooseTenant = async (
    ...
    try {
      ...
      await integrationService.selectTenant(
        provider,
        tenant
      );

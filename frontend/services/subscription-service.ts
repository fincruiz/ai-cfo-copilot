...
export type SubscriptionStatus={plan:'trial'|'founding'|'growth'|'enterprise';display_name:string;status:'trialing'|'active'|'past_due'|'cancelled'|'expired';trial_started_at?:string|null;trial_ends_at?:string|null;current_period_ends_at?:string|null;days_remaining?:number|null;entitlements:Record<string,string|number|boolean>;is_access_active:boolean;billing_managed_externally:boolean;billing_country_code?:string|null;billing_interval:'monthly'|'annual';requested_plan?:string|null;requested_interval?:'monthly'|'annual'|null;change_requested_at?:string|null;cancellation_requested_at?:string|null};

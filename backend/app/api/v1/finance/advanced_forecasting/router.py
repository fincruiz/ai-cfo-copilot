...
async def run(request:AdvancedForecastRequest,current_company:Annotated[Company,Depends(get_current_company)],service:Annotated[AdvancedForecastingService,Depends(svc)]):
...
async def power(request:PowerOfOneRequest,current_company:Annotated[Company,Depends(get_current_company)],service:Annotated[AdvancedForecastingService,Depends(svc)]):
